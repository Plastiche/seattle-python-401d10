...
Revision ID: f824d67bcc86
Revises: 
Create Date: 2018-12-20 09:43:19.811027
...
def upgrade():
    ...
    sa.Column('CEO', sa.String(length=256), nullable=True),
    sa.Column('issueType', sa.String(length=256), nullable=True),
